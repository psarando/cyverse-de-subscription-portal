...
export const OrderRequestSchema: Yup.ObjectSchema<OrderRequest> =
    CheckoutFormSchema.concat(
        Yup.object().shape({
            ...
            payment: Yup.object()
                // Need to set `default(undefined)` since object is optional,
                // but we need to prevent non-optional nested fields from
                // validating as missing:
                // https://github.com/jquense/yup?tab=readme-ov-file#object-schema-defaults
                .default(undefined)
                .shape({
